...
to_graph('./logs/a1_run.log')
to_graph('./logs/a2_run.log')

to_graph('./logs/b1_run.log')
to_graph('./logs/b2_run.log')
to_graph('./logs/a3_run.log')

to_graph('./logs/b1_run_fps.log')
to_graph('./logs/b1_run_uniform.log')
to_graph('./logs/b2_run_uniform.log')
