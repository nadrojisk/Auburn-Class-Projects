...
def test_parse_problem():
    ...
    expected_columns = 5
    expected_rows = 5
    expected_black_cells = [[2, 3, 2], [2, 5, 5],
                            [3, 2, 0], [3, 5, 0], [4, 4, 5]]
...
def test_calculate_fitness():
    ...
    board[4][1] = lightup.LIT

    assert lightup.calculate_fitness(board) == 100


def test_calculate_fitness_ignore_black_cells():
    board = np.zeros([5, 5], dtype=int)
    board.fill(-1)
    board[1][2] = 2
    board[1][4] = 5
    ...
    assert lightup.calculate_fitness(board, True) == 100


def test_calculate_fitness_bad_intersection():
    board = np.zeros([5, 5], dtype=int)
    board.fill(-1)
    board[1][2] = 2
    board[1][4] = 5
    ...
    assert lightup.calculate_fitness(board) == 0


def test_calculate_fitness_bad_cell_count():
    board = np.zeros([5, 5], dtype=int)
    board.fill(-1)
    board[1][2] = 2
    board[1][4] = 5
...
def test_calculate_fitness_bad_not_all_lit():
    board = np.zeros([5, 5], dtype=int)
    board.fill(-1)
    board[1][2] = 2
    board[1][4] = 5
    ...
    assert lightup.calculate_fitness(board) == 93
